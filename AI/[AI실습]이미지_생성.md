...
1. [Positive/Negative 프롬프팅 기법](#1-positivenegative-프롬프팅-기법)
2. [CLIP_Image-Test 유사도](#2-clip_image-test-유사도)
3. [ResNet-50 이미지 분류](#3-resnet-50-이미지-분류)
4. [ResNet18 모델 전이학습(리니어 프로빙)](#4-resnet18-모델-전이학습리니어-프로빙)
